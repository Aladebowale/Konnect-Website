  ...
  return (
    <div>
      ...
      <footer className="relative bg-gradient-to-b from-[#03173f] to-[#2657B0] text-white font-sans pt-6 pb-4">
        ...
        {/* Main footer content */}
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-8 relative z-20">
          <div className="grid grid-cols-1 md:grid-cols-6 gap-8 text-sm">
            ...
            <div className="space-y-4 md:col-span-1">
              ...
              <div className="flex gap-3 mb-4">
                {[FacebookIcon, TwitterIcon, LinkedInIcon, InstagramIcon, YouTubeIcon].map(
                  (icon, i) => (
                    <img key={i} src={icon} alt="social" className="w-6 h-6 cursor-pointer hover:opacity-80" />
                  )
                )}
              </div>
            ...
            <nav aria-label="Explore">
              ...
              <ul className="space-y-2 text-gray-300">
                <li>
                  <Link to="/Customers" className="hover:text-white transition">Customer</Link>
                </li>
                <li>
                  <Link to="/Pricing" className="hover:text-white transition">Pricing</Link>
                </li>
                <li>
                  <Link to="/Konn3ctDevs" className="hover:text-white transition">Developer</Link>
                </li>
              </ul>
            </nav>
            ...
            <nav aria-label="Company">
              ...
              <ul className="space-y-2 text-gray-300">
                <li>
                  <Link to="/Konn3ctTC" className="hover:text-white transition">Terms of Use</Link>
                </li>
                <li>
                  <Link to="/Konn3ctPP" className="hover:text-white transition">Privacy Policy</Link>
                </li>
                <li>NDPR</li>
                <li>GDPR</li>
              </ul>
          ...
          <div className="flex justify-between items-center mt-12 relative">
            ...
            <div className="flex items-center gap-3">
              <img src={Badge1} alt="Badge1" className="w-12 h-12" />
              <img src={Badge2} alt="Badge2" className="w-12 h-12" />
            </div>
          </div>
